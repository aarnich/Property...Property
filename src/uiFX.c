...
/*
    Prints a string in a stylistic fashion
...
void print1d(char str[], int strLength)
{
    ...
    {
        int randInterval = getRandNum(250,270);
...
/*
    Displays the changes in the player's balance in a flashy manner
...
/*
    Displays the changes in the both players' balances in a flashy manner
...
void displayContextFlair(enum winContext context, enum winner winningPlayer, char* p1Name, char* p2Name){
    ...
    if(context == ENEMY_LOSING_BALANCE)
    {
        ...
        char strFlair1[] = " constricted by the forces of capitalism..."; 
        print1d(strFlair1, strlen(strFlair1)); // animated print for message flair
        sleep_ms(1000);
        char strFlair2[] = " so tightly that you could not maintain a balance above the losing balance"; // animated print for losing balane flair
